...
CREATE TABLE users (
  ...
  phone VARCHAR(20),
  date_of_birth DATE,
  skill_level DECIMAL(3,1) CHECK (skill_level >= 10 AND skill_level <= 7.0),
...
CREATE TABLE sessions (
  ...
  skill_level_min DECIMAL(3,1) CHECK (skill_level_min >= 10 AND skill_level_min <= 7.0),
  skill_level_max DECIMAL(3,1) CHECK (skill_level_max >= 10 AND skill_level_max <= 7.0),
